...
/**
 * Created by jblandii on 7/05/18.
 */

public class AdaptadorAnimalesAntiguo extends RecyclerView.Adapter<AdaptadorAnimalesAntiguo.AnimalesViewHolder> implements View.OnClickListener {

    ArrayList<Animal> listaAnimales;
    Context context;
    private View.OnClickListener listener;

    public AdaptadorAnimalesAntiguo(ArrayList<Animal> listaAnimales) {
        this.listaAnimales = listaAnimales;
    }

    @Override
    public AdaptadorAnimalesAntiguo.AnimalesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AdaptadorAnimalesAntiguo.AnimalesViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AdaptadorAnimalesAntiguo.AnimalesViewHolder holder, int position) {
